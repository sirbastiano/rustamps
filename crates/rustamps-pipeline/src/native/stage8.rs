...
use rustamps_core::stage8::{estimate_scn, ScnConfig, ScnInputs};
use rustamps_io::{read_mat, write_mat, MatFile, StageTransaction};
...
fn write_output(
    ...
    n_ps: usize,
    n_ifg: usize,
    output: rustamps_core::stage8::ScnOutputs,
) -> Result<(), String> {
