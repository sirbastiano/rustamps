...
use crate::stage6_residual::{
    apply_residual_cycle, find_negative_unit_cycle, residual_arc_cost, ResidualArc,
};
...
fn push_candidate(candidates: &mut Vec<(i32, usize, usize)>, cost: i32, row: usize, col: usize) {
    candidates.push((cost, row, col));
    candidates.sort_unstable();
    candidates.truncate(LOCAL_WINDOW_LIMIT);
}
